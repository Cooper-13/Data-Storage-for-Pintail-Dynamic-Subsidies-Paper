# Inflation tool
# Source: https://www.r-bloggers.com/2016/10/use-r-to-calculate-inflation-with-the-blscraper-package/
# (-> more information at webpage; limit seems to be 10 years between startyear and endyear)
