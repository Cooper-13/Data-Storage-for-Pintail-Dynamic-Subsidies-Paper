...
#library(XLConnect)
Sys.setenv(JAVA_HOME = "C:/Program Files/Eclipse Adoptium/jdk-26.0.0.35-hotspot") # avoids error when loading XLConnect
## Load packages----
